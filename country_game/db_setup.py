...
def create_database():
    ...
    try:
        ...
        # Create database
        cursor.execute("CREATE DATABASE IF NOT EXISTS therendrim_game")
        print("Database created successfully")
        
        # Use the database
        cursor.execute("USE therendrim_game")
...
def import_data():
    ...
    try:
        ...
        conn = mysql.connector.connect(**config, database='therendrim_game')
        cursor = conn.cursor()
